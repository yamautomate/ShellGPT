@{
    ...
    FunctionsToExport = @('Invoke-CompletionAPI', 'New-CompletionAPIPrompt', 'Set-CompletionAPICharacter', 'New-CompletionAPIConversation', 'Add-CompletionAPIMessageToConversation', 'Start-ChatGPTforPowerShell', 'Import-PromptFromJson', 'Export-PromptToJson')
