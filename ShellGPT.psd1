@{
    ...
    FunctionsToExport = @('Invoke-OpenAICompletion', 'New-OpenAICompletionPrompt', 'Set-OpenAICompletionCharacter', 'New-OpenAICompletionConversation', 'Add-OpenAICompletionMessageToConversation', 'New-OpenAIEdit', 'New-OpenAIImage', 'Get-OpenAIModels', 'Get-OpenAIModelById', 'Get-OpenAIFiles','Get-OpenAIFileById', 'Get-OpenAIFileContent', 'New-OpenAIFile', 'Remove-OpenAIFile', 'Get-OpenAIFineTuneJobs','Get-OpenAIFineTuneJobById','Get-OpenAIFineTuneEvents', 'Remove-OpenAIFineTuneModel', 'Stop-OpenAIFineTuneJob', 'New-OpenAIFineTuneJob', 'New-OpenAIFineTuneTrainingFile', 'Import-OpenAIPromptFromJson', 'Export-OpenAIPromptToJson', 'New-OpenAIEmbedding', 'Convert-PDFtoText', 'Get-ShellGPTHelpMessage', 'Start-ShellGPT', 'Get-OpenAiQuickResponse', 'AzAI', 'OepnAI')
